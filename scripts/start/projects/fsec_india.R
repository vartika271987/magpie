...
for (scenarioName in c(
  ...
  "a_LiberalizedTrade",
  #"a_REDDaff", "a_REDD",
  "a_CropRotations", "a_LandSparing", "a_WaterSparing", "a_AirPollution",
  #"a_PeatlandSparing",
  ...
  #"b_NatureSparing",
  "b_AgroMngmt", "b_ExternalPressures","b_WaterSoil",
  ...
  "b_LivestockManureMngmt", "b_LivestockNUEMngmt", "b_AllNitrogen", "b_AllClimate",
  #"b_FullBiodiv",
