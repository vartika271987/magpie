...
for (scenarioName in c(
 ...
 "a_Population", "a_EconDevelop", "a_EnergyTrans",
  "a_NoUnderweight", "a_HalfOverweight", "a_DietVegFruitsNutsSeeds", "a_DietLegumes","a_LessFoodWaste",
  "a_DietMonogastrics", "a_DietRuminants", "a_DietEmptyCals",
#  "a_ManureMngmt", "a_LivestockMngmt",
  #"a_BiodivSparing",
 "a_NitrogenEff", "a_RiceMit",
#"a_CropeffTax",

 "a_CapitalSubst", "a_MinWage", "a_LiberalizedTrade",
#"a_Bioplastics", "a_LandscapeElements",
#   "a_TimberCities", "a_REDDaff", "a_REDD", "a_CropRotations",
  "a_LandSparing", "a_WaterSparing",
  #"a_PeatlandSparing",
  "a_SoilCarbon",
  ...
  "e_FSDP",
 "b_Diet",   "b_Livelihoods",
  #"b_NatureSparing",
#  "b_AgroMngmt",
  "b_ExternalPressures","b_WaterSoil",
...
"b_AllNitrogen",
  "b_AllClimate",
  #"b_FullBiodiv",
  "b_AllEnvironment", "b_AllHealth",
  #"b_Protection",
  "b_Efficiency", "b_AllInclusion", "b_LivelihoodsExt"
)) {
