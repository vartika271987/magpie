...
* transition to exogenous scenario diets
 ...
 i15_intake_NIN_all(i,kcal_scen15,EAT_scen15,kfo)       Food-specific per capita calorie intake according to NIN recommendations (kcal per capita per day)
 i15_intake_NIN(i,kfo)                  Food-specific per capita calorie intake according to NIN recommendations (kcal per capita per day)
